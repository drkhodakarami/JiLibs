...
{
    public TaggedSlot(Container inventory, int index, int x, int y, TagKey<Item> tagKey)
    {
        super(inventory, index, x, y, itemStack -> itemStack.is(tagKey));
    }

    public TaggedSlot(Container inventory, int index, int x, int y, int maxCount, TagKey<Item> tagKey)
    {
