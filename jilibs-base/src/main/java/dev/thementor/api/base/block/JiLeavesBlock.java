...
public class JiLeavesBlock extends Block implements Waterloggable
{
    public static MapCodec<? extends JiLeavesBlock> CODEC;

    public static final String DISTANCE_PROPERTY_NAME = "distance";
    public static final int DECAY_DISTANCE = 13;

    public static final IntProperty DISTANCE = IntProperty.of(DISTANCE_PROPERTY_NAME, 1, DECAY_DISTANCE);
    public static final BooleanProperty PERSISTENT = Properties.PERSISTENT;
    public static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;

    private static final int TICK_DELAY = 1;

    public JiLeavesBlock(Settings settings)
    {
        super(settings
